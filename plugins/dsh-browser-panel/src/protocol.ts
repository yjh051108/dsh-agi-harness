...
export const renderSnapshot = (snapshot: PageSnapshot, maxChars: number): string => {
...
export type PanelMessage =
  | { readonly kind: 'state'; readonly state: BrowserState }
  | { readonly kind: 'frame'; readonly jpegBase64: string }
