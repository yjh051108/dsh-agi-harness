...
| `plugins/dsh-engram-relay/lingshu/`（数据由灵枢 AEIS 生成） | 灵枢 AEIS 引擎（[CommonTrustProtocol](https://github.com/FuRongJun-1999/CommonTrustProtocol)，FuRongJun-1999） | MIT（引擎；见 lingshu/LICENSE-aeis.txt） |
